...
public class Inscription extends AppCompatActivity implements View.OnClickListener {
    ...
    public void uploadMultipart() {
        ...
        try {
            ...
            new MultipartUploadRequest(this, uploadId, com.example.faceid.Constants.UPLOAD_URL)
                    .addFileToUpload(path, "url") //Adding file
                    .addParameter("nom", nom) //Adding text parameter to the request
                    .addParameter("prenom", prenom)
    ...
    public void onClick(View v) {
        ...
        if (v == buttonUpload) {
            if(filePath!=null && editText1.getText().toString()!="" && editText2.getText().toString()!="" && editText3.getText().toString()!="") {
                uploadMultipart();
                Toast.makeText(Inscription.this,"Inscription terminée",Toast.LENGTH_LONG).show();
                Intent retour = new Intent(Inscription.this, MainActivity.class);
                startActivity(retour);
                overridePendingTransition(0, 0);
            } else {
                Toast.makeText(Inscription.this,"Informations incompletes",Toast.LENGTH_LONG).show();
            }
        }
    }
